...
class ClassDataArray {
    ...
    ClassDataArray(int max)            // Конструктор
    {
        a = new Person[max];                  // Создание массива
        nElems = 0;                           // Пока нет ни одного элемента
    }

    Person find(String searchName) {   // Поиск заданного значения
        int j;
    ...
    boolean delete(String searchName) { // Удаление из массива
        int j;
    ...
    void displayA()                     // Вывод содержимого массива
    {
